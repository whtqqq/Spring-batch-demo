...
public class ItemProcessorTest extends TestCase {
    ...
    private void assertEqualsRefStr(String CustRef, String CystRefNtv, String CustSubRef,
            String yPartNoDiv, String expectedOutptData) {
        try {
            FVQ_ItemProcessor outptItemProcessor = new FVQ_ItemProcessor();
            String actualOutptData = outptItemProcessor.getRefStr(CustRef, CystRefNtv, CustSubRef,
                    yPartNoDiv);
    ...
    private void assertEqualsLabelEarlyObjectDivJp(String labelEarlyDivJp, String deliDiv,
            String mcPlantDiv, String expectedOutptData) {
        try {
            FVQ_ItemProcessor outptItemProcessor = new FVQ_ItemProcessor();
            String actualOutptData = outptItemProcessor.getLabelEarlyObjectDivJp(labelEarlyDivJp,
                    deliDiv, mcPlantDiv);
            Assert.assertEquals(expectedOutptData, actualOutptData);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void testTmpPackingPrintFlgJp1() {
        ...
        assertEqualsTmpPackingPrintFlgJp(directShipFlg, shipToTempVoucherDiv, tmpFlg,
                expectedOutptData);
    }
    ...
    private void assertEqualsTmpPackingPrintFlgJp(String directShipFlg, String shipToTempVoucherDiv,
            String tmpFlg, String expectedOutptData) {
        try {
            FVQ_ItemProcessor outptItemProcessor = new FVQ_ItemProcessor();
            String actualOutptData = outptItemProcessor.getTmpPackingPrintFlgJp(directShipFlg,
                    shipToTempVoucherDiv, tmpFlg);
            Assert.assertEquals(expectedOutptData, actualOutptData);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void testCustName_2JpNotSpace() {
        ...
        Assert.assertEquals(billToCountryName.trim() + "/" + expectedCustName.trim(),
                actualCustname);
    }
    ...
    private void assertEqualsBrandProductCdJp(String productCdMst, String branNmForProductCd,
        ...
        try {
            FVQ_ItemProcessor outptItemProcessor = new FVQ_ItemProcessor();
            String actualOutptData = outptItemProcessor.getBrandProductCdJp(productCdMst,
                    branNmForProductCd);
            Assert.assertEquals(expectedOutptData, actualOutptData);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void testFinalCustNameEn1() {
        ...
        assertFinalCustNameEn(subsidiaryCd, custsubSubsidiaryCd, delFlsubsidiarySysDivg, result1,
                result2, expectedOutptData);
    }
    ...
    private void assertFinalCustNameEn(String subsidiaryCd, String custsubSubsidiaryCd,
            String delFlsubsidiarySysDivg, String result1, String result2,
            String expectedOutptData) {
        try {
            FVQ_ItemProcessor outptItemProcessor = new FVQ_ItemProcessor();
            String actualOutptData = outptItemProcessor.getFinalCustNameEn(subsidiaryCd,
                    custsubSubsidiaryCd, delFlsubsidiarySysDivg, result1, result2);
            Assert.assertEquals(expectedOutptData, actualOutptData);
        } catch (Exception e) {
            e.printStackTrace();
        }
