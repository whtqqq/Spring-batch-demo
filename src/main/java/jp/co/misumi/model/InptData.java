...
public class InptData {
	...
	public String toString() {
		return "InptData{" +
				...
				", totalQty=" + totalQty +
				", soAmount=" + soAmount +
				", subtotalSoAmount=" + subtotalSoAmount +
				", taxAmount=" + taxAmount +
				", tenthsDiscountedCost=" + tenthsDiscountedCost +
				", totalAmountPrice=" + totalAmountPrice +
				", deliNoteNoMjp=" + deliNoteNoMjp +
				", totalSAmountMjp=" + totalSAmountMjp +
				", ntvMcPlantName='" + ntvMcPlantName + '\'' +
				", classifyCd='" + classifyCd + '\'' +
				", brandName='" + brandName + '\'' +
				", ntvBrandName='" + ntvBrandName + '\'' +
				", brandNameForProductCd='" + brandNameForProductCd + '\'' +
				", shippingCarrierName='" + shippingCarrierName + '\'' +
				", shippingCarrierAbb='" + shippingCarrierAbb + '\'' +
				", ntvSubsidiaryName='" + ntvSubsidiaryName + '\'' +
				", subsidiaryName='" + subsidiaryName + '\'' +
				", subsidiaryNtvAddress_1='" + subsidiaryNtvAddress_1 + '\'' +
				", subsidiaryAddress_1='" + subsidiaryAddress_1 + '\'' +
				", subsidiaryNtvAddress_2='" + subsidiaryNtvAddress_2 + '\'' +
				", subsidiaryAddress_2='" + subsidiaryAddress_2 + '\'' +
				", subsidiaryNtvAddress_3='" + subsidiaryNtvAddress_3 + '\'' +
				", subsidiaryAddress_3='" + subsidiaryAddress_3 + '\'' +
				", subsidiaryNtvAddress_4='" + subsidiaryNtvAddress_4 + '\'' +
				...
				", deptCountryCd='" + deptCountryCd + '\'' +
				", ntvCountryName_1='" + ntvCountryName_1 + '\'' +
				", countryName='" + countryName + '\'' +
				", purcCountryName='" + purcCountryName + '\'' +
				", custUpsCountryCd='" + custUpsCountryCd + '\'' +
				", custNtvCountryName_1='" + custNtvCountryName_1 + '\'' +
				", custCountryName='" + custCountryName + '\'' +
				", originNtvCountryName_1='" + originNtvCountryName_1 + '\'' +
				", originCountryName='" + originCountryName + '\'' +
				", shipToUpsCountryCd='" + shipToUpsCountryCd + '\'' +
				", shipToNtvCountryName_1='" + shipToNtvCountryName_1 + '\'' +
				", shipToCountryName='" + shipToCountryName + '\'' +
				", billToNtvCountryName_1='" + billToNtvCountryName_1 + '\'' +
				", billToCountryName='" + billToCountryName + '\'' +
				", ntv1CompanyName='" + ntv1CompanyName + '\'' +
				", companyName='" + companyName + '\'' +
				", purcCountryCd='" + purcCountryCd + '\'' +
				", ntv2CompanyName='" + ntv2CompanyName + '\'' +
				", custShipmode='" + custShipmode + '\'' +
				", headerRef='" + headerRef + '\'' +
				", engHeaderRef='" + engHeaderRef + '\'' +
				", carrierAcctNo='" + carrierAcctNo + '\'' +
				", subsidiaryCd='" + subsidiaryCd + '\'' +
				", mcCd='" + mcCd + '\'' +
				", custCd='" + custCd + '\'' +
				", custsubSubsidiaryCd='" + custsubSubsidiaryCd + '\'' +
				", supplierCd='" + supplierCd + '\'' +
				", mcPlantDiv='" + mcPlantDiv + '\'' +
				", shipToCd='" + shipToCd + '\'' +
				", vrd=" + vrd +
				", vsd=" + vsd +
				", yPartNoDiv='" + yPartNoDiv + '\'' +
				", custRefLength=" + custRefLength +
				", custRef='" + custRef + '\'' +
				...
				", ntvDeliDept='" + ntvDeliDept + '\'' +
				", grp='" + grp + '\'' +
				", ntvDeliAttention='" + ntvDeliAttention + '\'' +
				", brandCd='" + brandCd + '\'' +
				", ntvCustDept='" + ntvCustDept + '\'' +
				", ntvCustAttention='" + ntvCustAttention + '\'' +
				", custsubMcPlantCd='" + custsubMcPlantCd + '\'' +
				", paymentTerms='" + paymentTerms + '\'' +
				", incoterms='" + incoterms + '\'' +
				", settlementMethod='" + settlementMethod + '\'' +
				", voucherDiv='" + voucherDiv + '\'' +
				", custsubCustCd='" + custsubCustCd + '\'' +
				", custsubShipToCd='" + custsubShipToCd + '\'' +
				", custCategoryCd='" + custCategoryCd + '\'' +
				...
				", includeTaxSUPrice=" + includeTaxSUPrice +
				", otherDsctAmount=" + otherDsctAmount +
				", crd=" + crd +
				", transportMeans='" + transportMeans + '\'' +
				", hazardFlg='" + hazardFlg + '\'' +
				", directShipFlg='" + directShipFlg + '\'' +
				", automobileStandardCd='" + automobileStandardCd + '\'' +
				", storkChargeApplyDiv='" + storkChargeApplyDiv + '\'' +
				", deliNoteNo='" + deliNoteNo + '\'' +
				", originalDeliNoteNo='" + originalDeliNoteNo + '\'' +
				", productCdMst='" + productCdMst + '\'' +
				", poQtyPerCase=" + poQtyPerCase +
				", hsCd='" + hsCd + '\'' +
				", ntvProductName='" + ntvProductName + '\'' +
				", productName='" + productName + '\'' +
				", productControlDepCode='" + productControlDepCode + '\'' +
				", unitOfMeasure='" + unitOfMeasure + '\'' +
				", ntvClassifyCdName='" + ntvClassifyCdName + '\'' +
				", classifyCdName='" + classifyCdName + '\'' +
				", tempVoucherDiv='" + tempVoucherDiv + '\'' +
				", shipToFrtAreaCd='" + shipToFrtAreaCd + '\'' +
				", shipToBusinessinstruct1ShowFlg='" + shipToBusinessinstruct1ShowFlg + '\'' +
				", shipToNtvBusinessinstruct1='" + shipToNtvBusinessinstruct1 + '\'' +
				", shipToBusinessinstruct2ShowFlg='" + shipToBusinessinstruct2ShowFlg + '\'' +
				", shipToNtvBusinessinstruct2='" + shipToNtvBusinessinstruct2 + '\'' +
				", shipToPackingInstruct1ShowFlg='" + shipToPackingInstruct1ShowFlg + '\'' +
				", shipToNtvPackingInstruct1='" + shipToNtvPackingInstruct1 + '\'' +
				", shipToPackingInstruct2ShowFlg='" + shipToPackingInstruct2ShowFlg + '\'' +
				", shipToNtvPackingInstruct2='" + shipToNtvPackingInstruct2 + '\'' +
				", ntvShipToName1='" + ntvShipToName1 + '\'' +
				", shipToName='" + shipToName + '\'' +
				", shipToNtvAddress_1='" + shipToNtvAddress_1 + '\'' +
				", shipToHalfwidthAddress_1='" + shipToHalfwidthAddress_1 + '\'' +
				", shipToNtvAddress_2='" + shipToNtvAddress_2 + '\'' +
				", shipToHalfwidthAddress_2='" + shipToHalfwidthAddress_2 + '\'' +
				", shipToNtvAddress_3='" + shipToNtvAddress_3 + '\'' +
				", shipToHalfwidthAddress_3='" + shipToHalfwidthAddress_3 + '\'' +
				", shipToNtvAddress_4='" + shipToNtvAddress_4 + '\'' +
				", shipToHalfwidthAddress_4='" + shipToHalfwidthAddress_4 + '\'' +
				", shipToPostalCd='" + shipToPostalCd + '\'' +
				", shipToCountryCdMst='" + shipToCountryCdMst + '\'' +
				", shipToCityName='" + shipToCityName + '\'' +
				", shipToTel='" + shipToTel + '\'' +
				", shipToFax='" + shipToFax + '\'' +
				", shipToMailAddress='" + shipToMailAddress + '\'' +
				", shipToDeliAttention='" + shipToDeliAttention + '\'' +
				", shipToDeliDept='" + shipToDeliDept + '\'' +
				", ntvShipToName2='" + ntvShipToName2 + '\'' +
				", shipToCityCd='" + shipToCityCd + '\'' +
				", subsidiaryNtvShipToName1='" + subsidiaryNtvShipToName1 + '\'' +
				", subsidiaryShipToName='" + subsidiaryShipToName + '\'' +
				", mcSpecifyVoucherDiv='" + mcSpecifyVoucherDiv + '\'' +
				", deliNoteSendFlg='" + deliNoteSendFlg + '\'' +
				", custFrtAreaCd='" + custFrtAreaCd + '\'' +
				", comInvFlg='" + comInvFlg + '\'' +
				...
				", deliOrderPrintNumCopy=" + deliOrderPrintNumCopy +
				...
				", packListRetainFlg='" + packListRetainFlg + '\'' +
				...
				", ntvCustName1='" + ntvCustName1 + '\'' +
				", custName='" + custName + '\'' +
				", custNtvAddress_1='" + custNtvAddress_1 + '\'' +
				", custHalfwidthAddress_1='" + custHalfwidthAddress_1 + '\'' +
				", custNtvAddress_2='" + custNtvAddress_2 + '\'' +
				", custHalfwidthAddress_2='" + custHalfwidthAddress_2 + '\'' +
				", custNtvAddress_3='" + custNtvAddress_3 + '\'' +
				", custHalfwidthAddress_3='" + custHalfwidthAddress_3 + '\'' +
				", custNtvAddress_4='" + custNtvAddress_4 + '\'' +
				", custHalfwidthAddress_4='" + custHalfwidthAddress_4 + '\'' +
				", custCountryCdMst='" + custCountryCdMst + '\'' +
				", custCityName='" + custCityName + '\'' +
				", custCityCd='" + custCityCd + '\'' +
				", custTel='" + custTel + '\'' +
				", custFax='" + custFax + '\'' +
				", custBusinessinstruct1ShowFlg='" + custBusinessinstruct1ShowFlg + '\'' +
				", custNtvBusinessinstruct1='" + custNtvBusinessinstruct1 + '\'' +
				", custBusinessinstruct2ShowFlg='" + custBusinessinstruct2ShowFlg + '\'' +
				", custNtvBusinessinstruct2='" + custNtvBusinessinstruct2 + '\'' +
				", custPackingInstruct1ShowFlg='" + custPackingInstruct1ShowFlg + '\'' +
				", custNtvPackingInstruct1='" + custNtvPackingInstruct1 + '\'' +
				", custPackingInstruct2ShowFlg='" + custPackingInstruct2ShowFlg + '\'' +
				", custNtvPackingInstruct2='" + custNtvPackingInstruct2 + '\'' +
				", custOfficeLicenseNo='" + custOfficeLicenseNo + '\'' +
				", custBillToCd='" + custBillToCd + '\'' +
				...
				", ntvCustName2='" + ntvCustName2 + '\'' +
				", cellCd='" + cellCd + '\'' +
				", custMailAddressFlg='" + custMailAddressFlg + '\'' +
				", packingFlg='" + packingFlg + '\'' +
				", packingPrintNumOrgn=" + packingPrintNumOrgn +
				", packingPrintNumCopy=" + packingPrintNumCopy +
				", packingRetainFlg='" + packingRetainFlg + '\'' +
				", engPackingFlg='" + engPackingFlg + '\'' +
				", engPackingPrintNumOrgn=" + engPackingPrintNumOrgn +
				", engPackingPrintNumCopy=" + engPackingPrintNumCopy +
				", engPackingRetainFlg='" + engPackingRetainFlg + '\'' +
				", tmpPackingFlg='" + tmpPackingFlg + '\'' +
				", tmpPackingPrintNumOrgn=" + tmpPackingPrintNumOrgn +
				", tmpPackingPrintNumCopy=" + tmpPackingPrintNumCopy +
				", tmpPackingRetainFlg='" + tmpPackingRetainFlg + '\'' +
				", invoiceFlg='" + invoiceFlg + '\'' +
				", invoicePrintNumOrgn=" + invoicePrintNumOrgn +
				", invoicePrintNumCopy=" + invoicePrintNumCopy +
				", invoiceRetainFlg='" + invoiceRetainFlg + '\'' +
				", customerNtvCustName1='" + customerNtvCustName1 + '\'' +
				", customerCustName='" + customerCustName + '\'' +
				", labelEarlyDiv='" + labelEarlyDiv + '\'' +
				...
				", ntvBillToName='" + ntvBillToName + '\'' +
				", billToName='" + billToName + '\'' +
				", billToNtvAddress_1='" + billToNtvAddress_1 + '\'' +
				", billToHalfwidthAddress_1='" + billToHalfwidthAddress_1 + '\'' +
				", billToNtvAddress_2='" + billToNtvAddress_2 + '\'' +
				", billToHalfwidthAddress_2='" + billToHalfwidthAddress_2 + '\'' +
				", billToNtvAddress_3='" + billToNtvAddress_3 + '\'' +
				", billToHalfwidthAddress_3='" + billToHalfwidthAddress_3 + '\'' +
				", billToNtvAddress_4='" + billToNtvAddress_4 + '\'' +
				", billToHalfwidthAddress_4='" + billToHalfwidthAddress_4 + '\'' +
				...
				", receivableMcCd='" + receivableMcCd + '\'' +
				", barcodeGlobalNo='" + barcodeGlobalNo + '\'' +
				", supplierInvNo='" + supplierInvNo + '\'' +
				", childSeq=" + childSeq +
				", globalNoPo='" + globalNoPo + '\'' +
				", subsidiaryPlantDeptName='" + subsidiaryPlantDeptName + '\'' +
				", subsidiaryPlantAddress_1='" + subsidiaryPlantAddress_1 + '\'' +
				", subsidiaryPlantAddress_2='" + subsidiaryPlantAddress_2 + '\'' +
				", subsidiaryPlantAddress_3='" + subsidiaryPlantAddress_3 + '\'' +
				", subsidiaryPlantAddress_4='" + subsidiaryPlantAddress_4 + '\'' +
				", subsidiaryPlantPostalCd='" + subsidiaryPlantPostalCd + '\'' +
				", subsidiaryPlantTel='" + subsidiaryPlantTel + '\'' +
				", subsidiaryPlantFax='" + subsidiaryPlantFax + '\'' +
				", ntvDeptNameAbb='" + ntvDeptNameAbb + '\'' +
				", plantDeptTel='" + plantDeptTel + '\'' +
				", orderMsgCd='" + orderMsgCd + '\'' +
				", hdCommentForLogistics='" + hdCommentForLogistics + '\'' +
				", dtComment='" + dtComment + '\'' +
				", delFlg='" + delFlg + '\'' +
				...
				", soSubsidiaryCd='" + soSubsidiaryCd + '\'' +
				", cellName='" + cellName + '\'' +
				", ntvCellName='" + ntvCellName + '\'' +
				'}';
	}
}